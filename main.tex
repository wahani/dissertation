...
% \cleardoublepage\include{tex/Publication} % Publications from the thesis page
...
\ctparttext{This is the chapter where I want to present the theoretical concepts underpinning the development of software and application.} % Text on the Part 2 page describing the content in Part 2
...
\input{Rmd/theory_area_level_models}
\input{Rmd/theory_compare_unit_and_area}
\input{Rmd/theory_spatio_temporal_fh}

\section{Robust Methods in Small Area Estimation}
\input{Rmd/theory_robust_rao}
\subsection{Mean squared error}
\subsubsection{Bootstrap}
\input{Rmd/theory_rfh_pseudo_linear}

...
is robust against outliers. On each sample then a non robust small area 
...
@Bel06 and @Hua06 both use the t-distribution to model the random effect in the 
  ...
  observations are outliers and fit a seperate model. All these studies can
  claim some advantages for their respective method when outliers are present.

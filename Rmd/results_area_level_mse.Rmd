...
measure of uncertainty with respect to this quantity. To this extend two MSPE 
estimators have been proposed in Section \ref{sec:theory_rfh_mse}: an adoption 
of the parametric bootstrap proposed by @Sin09 and a MSPE estimator based on
the pseudolinearisation approach by @Cha11. In the following these two MSPE
estimator are compared in different simulation settings.

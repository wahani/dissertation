...
General Linear Mixed Models which is typically associated with restricted
Maximum Likelihood, Empirical Bayes and Hierarchical Bayes. Although these
different frameworks for estimation differ with respect to optimality criteria,
e.g. MSE and squared error loss, equivalence of the different derived estimators
can be shown for special cases. A more general discussion of misxed models in
SAE can be found in @Jia06; @Rao03 and @Rao15 provide a comprohensive overview
and comparisson of the different frameworks.

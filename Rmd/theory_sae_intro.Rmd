...
Battese-Harter-Fuller (BHF) model which was introduced by @Bat88 are the two
basic models which are used for area\hyp{} and unit\hyp{}level models
respectively. Underlying is the idea to use auxiliary information in a
...
these different frameworks for estimation differ with respect to optimality 
criteria, equivalence of the different derived estimators can be shown for
special cases. A more general discussion of misxed models in SAE can be found in
@Jia06; @Rao03 and @Rao15 provide a comprohensive overview and comparisson of
...
@Sin09 develop a robustified EBLUP and @Bea09 refer to a winzorization of the

...
estimator is bounded but the influence of the pair of direct estimator and 
sampling variance as well. In fact the introduction of the robust area level
model can be considered to have a positive effect with respect to both scenarios
because single observations are restricted in their influence. Furthermore the
robust model may present an alternative to smoothing strategies -- although this
may not have been the initial intention -- without loosing the ability to weight

...
Chambers (1986) uses
the term representative outliers to describe observations which are cor-
rectly recorded and can not be assumed to be unique. Non-representa-
tive outliers, on the other hand, may be best described as not correctly
recorded and should be imputed or generally dealt with during the
editing process of survey data

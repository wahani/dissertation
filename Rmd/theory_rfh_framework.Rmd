...
In contrast to these available approaches I follow the main results of @Sin09 to derive robust estimation equations for linear mixed models. Furthermore the introduced models allow to model unobserved spatial and temporal structures in the random effects, which has not been explored 

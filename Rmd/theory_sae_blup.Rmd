...
\end{align}
}The BLUP \eq{eq:blup} of $\mu$ depends on known variance components
...
\tilde{\re}(\hat{\delta})$. To estimate $\delta$ a variety of estimators have been
...
approximation. @Pra90 used instead the approximation by
\empty{
\begin{align*}
...
predictions under linear mixed models but to any predictor which can be
...
context of longitudinal linear mixed models and was modified by @Loh09 into a

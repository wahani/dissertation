...
for unit level models. In Chapter \ref{chap:rfh} these results are extended to
the area level; here the basic unit level model and unit level notation is
reviewed in order to be able to give some more details in the following Section
\ref{sec:saerobust}. A review of unit level models in the context of linear
mixed models and EBLUP based predictions can be found in @Jia06 and also in
@Rao03 and @Rao15 who also review a variety of extensions.
...
$\pmat\beta$, $\sigre$ and $\sigma_e^2$, can be estimated using standard ML and REML
estimation techniques and are based on the sampled data.

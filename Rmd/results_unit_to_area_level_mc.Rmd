...
section? holds, i.e. there are no outliers. Here $\sigma_e^2 = 4^2$ and $\sigv =
...
from 1 to 3.2 for their respective sample size. $\sigv = 1$.
...
choose $\sigv = 1$ for the areas where $i \in \{1, \dots, 95\}$ and $\sigv = 

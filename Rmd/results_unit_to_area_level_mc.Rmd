...
In practice it might be desiarable to use a bootstrap to estimate the variance 
of the sample median which showed to be unreliable with these small samples. 
Hence leading to utilising the MAD to this extend. Third, it may be argued that 
a different robust method should be considered. In a simulation using a M-type 
estimator for the sample mean in conjunction with a robust variance estimator
yielded very similar results as we can observe for the median.

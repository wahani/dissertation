...
using the $b$th bootstrap sample and $\theta_i^{*(b)}$ denotes the true value of the 
...
asymmetric outliers. The estimator is evaluated in Section (?) where its
properties are compared to the bootstrap methods presented earlier.

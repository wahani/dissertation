...
and based on the Structural Business Survey (SBS). The target domains here are 
industry sectors and the target statistic is the annual tax\hyp{}turnover within 
the domains. Using this data we can study several effects on the domain
...
is an annual business survey in the Netherlands. The data used in the present
study is a synthetic population generated from that survey. Furthermore the
sampling scheme used in this study is similar to that used in the SBS and it is
...
compared with the direct estimator. This is so since we use a strong predictor 
...
At present it is not clear how to dress this issue. It may be helpful to 

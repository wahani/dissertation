...
The solution by @Chat12 was based on the idea to add the term
...
general case. Hence starting from \eq{eq:rfhreed} we can write:
\empty{
\begin{align*}
...
applicable when we set $\delta = \sigre$ and use otherwise the notation in

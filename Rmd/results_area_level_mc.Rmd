...
and spatial FH model is treated as special case when we only use the data from 
...
specification under a unified strategy.
...
way as for *(0, u)* however $\rho = 0.5$ for the generation of the regular observations.

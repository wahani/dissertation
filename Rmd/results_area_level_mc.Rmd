...
\Distr{N}(0, \sigv)$ where $\sigv$ is defined with respect to the scenario.
...
scenario $\sigv = 1$.
2. *(v, 0)* This is the scenario with area level outliers. $\sigv = 1$ for 95 \%
of the areas, i.e. for $i \in \{1, \dots, 95\}$, and $\sigv = 20^2$ for $i \in
\{96, \dots, 100\}$.

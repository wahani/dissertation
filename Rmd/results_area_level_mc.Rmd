...
the Monte Carlo repetitions directly from the area level model. This is a 
...
considered where the spatial and temporal correlation is set to $\rho = \rho_1 =
\rho_2$ and the respective variance parameters to$\sigma_u^2 = \sigma_1^2 = 
...
equations at their respective solutions reveal non\hyp{}satifying results, i.e.
...
RBIAS and RRMSPE in the presence of outliers. Allthough not shown explicitly

...
\newcommand{\myTitlei}{Small Area Estimation\xspace}
\newcommand{\myTitleii}{Using Robust Extensions to Area Level Models\xspace}

\newcommand{\myTitle}{\myTitlei \myTitleii}
\newcommand{\mySubtitle}{Theory, Implementation and Simulation Studies\xspace}
\newcommand{\myDegree}{Submitted in fulfillment of \\ the requirements for the degree \\ \textbf{Dr. rer. pol.}\xspace}
...
\newcommand{\myFaculty}{School of Business \& Economics\xspace}
\newcommand{\myDepartment}{Professur f\"ur Angewandte Statistik\xspace}
\newcommand{\myUni}{Freie Universit\"at Berlin\xspace}
...
\PassOptionsToPackage{british, ngerman}{babel}  % Change this to your language(s)

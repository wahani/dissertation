...
\newcommand{\myTitle}{Small Area Estimation using Robust Extensions to Area Level Models\xspace}
\newcommand{\mySubtitle}{Theory, Implementation, and Simulation Studies\xspace}
\newcommand{\myDegree}{Submitted in fulfillment for the degree \\ Dr. rer. pol.\xspace}
